	        ...
	        <Tailwind>
		        <Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
					<Section className="text-center">
						...
						Your account has been completely wiped from the StreamFlow database. All your data and information has been irretrievably deleted.
						</Text>
					</Section>
					<Section className="bg-white text-black text-center rounded-lg shadow-md p-6 mb-4">
						<Text>
							You will no longer receive notifications on Telegram or in the mail.
						</Text>
						<Text>
							If you would like to return to the platform, you can sign up using the following link:
						</Text>
						<Link
							href={registerLink}
						...
						>
							Sign up for StreamFlow
						</Link>
					</Section>

					<Section className="text-center text-black">
						<Text>
							Thank you for being with us! We always look forward to seeing you on the platform.
						</Text>
					</Section>
		        </Body>
	        </Tailwind>
